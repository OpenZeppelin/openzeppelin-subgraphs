...
function registerTransfer(
  ...
  let token = fetchERC1155Token(contract, id, event.block); // GOSHA: passing block from the event param ||| To be able to do so, I've added new field in the erc1155.gql.json, row 30
