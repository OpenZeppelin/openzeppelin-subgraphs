...
export function fetchERC721(address: Address): ERC721Contract | null {
  ...
  if (detectionAccount == null) {
    ...
    let introspection_80ac58cd =
      supportsInterface(erc721, "80ac58cd") ||
      "0x86935f11c86623dec8a25696e1c19a8659cbf95d" == account.id; // ERC721
...
export function fetchERC721Token(
  ...
  identifier: BigInt,
  mintBlock?: BigInt // GOSHA: Added new optional param
): ERC721Token {
  ...
  if (token == null) {
    ...
    token.mintBlock = mintBlock; // GOSHA: Saving block in the token entity
